...
if __name__ == "__main__":
   ...
   RX=24
   TX=25
   TX_TEST_ON = "0000000000"
   TX_TEST_OFF = "1111111111"
   TX_REPEAT = 3
   RX_REPEAT = 0
   ...
   print "Transmit testing sending", TX_TEST_ON, TX_REPEAT, "times"
   tx.put(TX_TEST_ON, TX_REPEAT)
   
   time.sleep(2)

   print "Transmit testing sending", TX_TEST_OFF, TX_REPEAT, "times"
   tx.put(TX_TEST_OFF, TX_REPEAT)
